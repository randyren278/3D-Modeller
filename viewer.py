...
from models.primitive import init_primitives, G_OBJ_PLANE
from models.node import Sphere, Cube, SnowFigure
from models.scene import Scene

class Viewer(object):
    def __init__(self):
        """ Initialize the viewer. """
        print("Viewer: Initializing interface...")
        self.init_interface()
        print("Viewer: Initializing OpenGL...")
        self.init_opengl()
        print("Viewer: Initializing scene...")
        self.init_scene()
        print("Viewer: Initializing interaction...")
        self.init_interaction()
        print("Viewer: Initializing primitives...")
        init_primitives()
    ...
    def init_opengl(self):
        ...
        print("Viewer: Setting up OpenGL parameters...")
    ...
    def init_scene(self):
        ...
        print("Viewer: Creating scene...")
        self.scene = Scene()
        self.create_sample_scene()

    def create_sample_scene(self):
        print("Viewer: Creating sample scene...")
        cube_node = Cube()
    ...
    def init_interaction(self):
        ...
        print("Viewer: Initializing interaction callbacks...")
    ...
    def main_loop(self):
        print("Viewer: Entering main loop...")
        glutMainLoop()

    def render(self):
        """ The render pass for the scene """
        print("Viewer: Rendering scene...")
        self.init_view()
    ...
    def init_view(self):
        ...
        print("Viewer: Initializing view...")
    ...
    def get_ray(self, x, y):
        ...
        print(f"Viewer: Getting ray for coordinates ({x}, {y})...")
        self.init_view()
