...
import utils.trackball as trackball

class Interaction(object):
    def __init__(self):
        """ Handles user interaction """
        print("Interaction: Initializing...")
    ...
    def register(self):
        ...
        print("Interaction: Registering callbacks...")
        glutMouseFunc(self.handle_mouse_button)
        glutMotionFunc(self.handle_mouse_move)
        glutKeyboardFunc(self.handle_keystroke)
        glutSpecialFunc(self.handle_keystroke)
        print("Interaction: Callbacks registered.")

    def register_callback(self, name, func):
        """ registers a callback for a certain event """
        print(f"Interaction: Registering callback for {name}...")
        self.callbacks[name].append(func)

    def trigger(self, name, *args, **kwargs):
        """ calls a callback, forwards the args """
        print(f"Interaction: Triggering {name} callback...")
    ...
    def handle_mouse_button(self, button, mode, x, y):
        ...
        print(f"Interaction: Mouse button {'pressed' if mode == GLUT_DOWN else 'released'} at ({x}, {y})...")
    ...
    def handle_mouse_move(self, x, screen_y):
        ...
        print(f"Interaction: Mouse moved to ({x}, {screen_y})...")
        xSize, ySize = glutGet(GLUT_WINDOW_WIDTH), glutGet(GLUT_WINDOW_HEIGHT)
    ...
    def handle_keystroke(self, key, x, screen_y):
        ...
        print(f"Interaction: Keystroke {key} at ({x}, {screen_y})...")
        xSize, ySize = glutGet(GLUT_WINDOW_WIDTH), glutGet(GLUT_WINDOW_HEIGHT)
        y = ySize - screen_y
        if key == b's':
